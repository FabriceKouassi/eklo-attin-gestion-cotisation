...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="ess-form-checked" autocomplete="off" method="post" action="{{ route('actualite.new') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            data-msg="Veuillez renseigné le titre de l'actualite" value="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
