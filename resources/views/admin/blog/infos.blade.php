...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="ess-form-checked" autocomplete="off" method="post" action="{{ route('blog.update') }}" enctype="multipart/form-data">
                @csrf

                <input type="hidden" name="itemId" value="{{ $blog->id }}">
                <div class="row">
                    <div class="col-md-4">
                        <img src="{{ $blog->getImg() }}" alt="{{ $blog->img_alt }}" style="width: 100%;">
                    </div>
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    data-msg="Veuillez renseigné le titre de l'blog" value="{{ $blog->title ?? ''}}"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    data-msg="La balise ALT de l'image est importante pour le réferencement. Veuillez renseigner le champs svp" value="{{ $blog->img_alt ?? ''}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="doc_alt" value="{{ $blog->doc_alt }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="content" id="description" class="text-editor form-control ess-is-required" required rows="4"
                                        data-msg="Veuillez renseigner la description">{{ $blog->content }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
