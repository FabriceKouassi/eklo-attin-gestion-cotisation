        ...
        <div class="card o-hidden border-0 shadow-lg my-5 login-form">
            ...
            <div class="row">
                ...
                <div class="p-5">
                    ...
                    <form class="user ess-form-checked" autocomplete="off" action="{{ route('update.password') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <input type="hidden" class="form-control form-control-user ess-is-required @error('email') is-invalid @enderror"
                            name="email" value="{{ $user->email }}">
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control form-control-user ess-is-required @error('password') is-invalid @enderror"
                            name="password" placeholder="Saisissez votre nouveau mot de passe..." data-msg="Saissez votre nouveau mot de passe"
                            value="{{ old('password') }}" autocomplete="password" autofocus>
                        </div>
                        <div class="form-group">
                            <input type="password" class="form-control form-control-user ess-is-required @error('confirm_password') is-invalid @enderror"
                            name="confirm_password" placeholder="Confirmer votre nouveau mot de passe..." data-msg="Confirmer votre nouveau mot de passe"
