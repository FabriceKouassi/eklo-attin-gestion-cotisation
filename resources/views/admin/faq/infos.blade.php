...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form class="ess-form-checked" autocomplete="off" method="post" action="{{ route('faq.update') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="itemId" value="{{ $faq->id }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    data-msg="Veuiller renseigner la question"  value="{{ $faq->question }}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="response" class="form-control ess-is-required" rows="4"
                                        data-msg="Veuiller renseigner la reponse de cette question">
                                        {{ $faq->response }}
                                    </textarea>
                                </div>
                            </div>
