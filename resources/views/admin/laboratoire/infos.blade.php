...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form class="ess-form-checked" autocomplete="off" method="post" action="{{ route('laboratoire.update') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="itemId" value="{{ $laboratoire->id }}">

                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Choisir le type du laboratoire</label>
                                    <select class="form-control" name="laboratoireType" data-msg="Veuiller selectionner le type du laboratoire">
                                        @foreach ($laboratoireType as $item)
                                            <option value="{{ $item->id}}" {{ (int) $laboratoire->laboratoire_types_id === (int) $item->id ? 'selected="selected"' : "" }}>
                                                {{ $item->nom }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    data-msg="Veuillez renseigner le nom du laboratoire" value="{{ $laboratoire->nom }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    data-msg="Veuillez renseigner la description du laboratoire">{{ $laboratoire->description }}</textarea>
                                </div>
                            </div>
                            {{-- <div class="col-md-6">
                                <div class="form-group">
