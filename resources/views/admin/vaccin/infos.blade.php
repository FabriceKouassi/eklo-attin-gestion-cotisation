...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form class="ess-form-checked" autocomplete="off" method="post" action="{{ route('vaccin.update') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="itemId" value="{{ $vaccin->id }}">

                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="exampleFormControlSelect1">Choisir le type du vaccin</label>
                                    <select class="form-control" name="vaccinFamille" data-msg="Veuiller selectionner le type du vaccin">
                                        @foreach ($vaccinFamille as $item)
                                            <option value="{{ $item->id}}" {{ (int) $vaccin->vaccin_famille_id === (int) $item->id ? 'selected="selected"' : "" }}>
                                                {{ $item->libelle }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    data-msg="Veuiller renseigner le titre du tableau" value="{{ $vaccin->title }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    data-msg="Veuiller renseigner le cout du vaccin" value="{{ $vaccin->cout }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
