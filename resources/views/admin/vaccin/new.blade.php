...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('vaccin.all') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        <i class="fas fa-arrow-left fa-sm text-white-50"></i></a>
    </div>

    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="ess-form-checked" autocomplete="off" method="post" action="{{ route('vaccin.new') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="vaccinFamille"
                                data-msg="Veuiller selectionner le type du vaccin">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            data-msg="Veuiller renseigner le titre du tableau" value="{{ trim(Request::old('title')) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            data-msg="Veuiller renseigner le cout du vaccin" value="{{ trim(Request::old('cout')) }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea name="frequence" cols="3" rows="3" class="form-control ess-is-required text-editor" data-msg="Veuiller renseigner la frequence ou le schema vaccinal">
                                {{ trim(Request::old('frequence')) }}
                            </textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
