...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <form class="ess-form-checked" autocomplete="off" method="post" action="{{ route('document.new') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="exampleFormControlSelect1">Choisir le type de document</label>
                            <select class="form-control" name="documentType"
                                data-msg="Veuiller selectionner le type de document">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            data-msg="Veuillez renseigné le titre du document" value="">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
