        ...
        <div class="card o-hidden border-0 shadow-lg my-5 login-form">
            ...
            <div class="row">
                ...
                <div class="p-5">
                    ...
                    <form class="user ess-form-checked" autocomplete="off" action="{{ route('reset.verification') }}" method="POST">
                        @csrf
                        <div class="form-group">
                            <input type="text" class="form-control form-control-user ess-is-required @error('otp') is-invalid @enderror"
                            name="otp" placeholder="Coller ici l'OTP..." data-msg="Consulter votre mail, copier puis coller ici le code OTP reçu"
                            value="{{ old('otp') }}" autocomplete="otp" autofocus>
                        </div>
