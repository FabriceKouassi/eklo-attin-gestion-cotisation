...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <form class="ess-form-checked" autocomplete="off" method="post" action="{{ route('fonction.update') }}" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="itemId" value="{{ $fonction->id }}">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    data-msg="Veuillez renseigner le libelle" value="{{ $fonction->libelle }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    data-msg="Veuillez renseigner le montant" value="{{ $fonction->montant }}">
                                </div>
                            </div>
                        </div>
