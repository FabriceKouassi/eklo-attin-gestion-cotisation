...
@section('content')
    <section class="section-full-white">
        <div class="text-justify">
            ...
            <div class="back-img-parallax" style="background-image: url('{{ $politique->getImg() }}');"></div>
        ...
        <div class="text-center">
            <a href="{{ $politique->getDoc() }}" class="btn-download-1" download="{{ $politique->doc }}" style="{{ $politique->doc == null ? 'visibility: hidden;' : '' }}" title="Télecharger la brochure">
