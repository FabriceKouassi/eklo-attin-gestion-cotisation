...
@section('content')
    <section class="section-full-white">
        <div class="" style="text-align: justify;">
            ...
            <div class="back-img-parallax" style="background-image: url('{{ $mission->getImg() }}');"></div>
        ...
        <div class="text-center">
            <a href="{{ $mission->getDoc() }}" class="btn-download-1" download="{{ $mission->doc }}" style="text-align: center; {{ $mission->doc == null ? 'visibility: hidden;' : '' }}" title="Télecharger la brochure">
